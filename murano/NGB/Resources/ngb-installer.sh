...
git clone https://atul.pandey_india.nec.com:3wDxsN8GBg@gitlab.neclab.eu/darp-git-NLENECIT/NGSI-LDBroker.git
cd NGSI-LDBroker/BinariesForTesting
chmod +x run.sh
...
#while [[ $(netstat -tnlp | grep 8761) != true ]]
#do
#  echo "Retrying..."
